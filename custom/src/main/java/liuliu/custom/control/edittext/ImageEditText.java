...
public class ImageEditText extends LinearLayout {
    ...
    public void setCenterTextRedColor2() {
        ...
        ColorStateList csl = (ColorStateList) resource.getColorStateList(R.color.main_lab_color);
    ...
    public void setMainClick(MainClickListener listener) {
        mClick = listener;
    }
